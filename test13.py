...
class MyFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText4 = wx.StaticText( self, wx.ID_ANY, u"选择项目：", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_filePicker = wx.FilePickerCtrl( self, wx.ID_ANY, wx.EmptyString, u"选择要执行的项目", u"*.*", wx.DefaultPosition, wx.Size( 500,-1 ), wx.FLP_DEFAULT_STYLE )
		self.m_filePicker.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOWFRAME ) )
		self.m_filePicker.SetBackgroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOWFRAME ) )
		
		fgSizer3.Add( self.m_filePicker, 0, wx.ALL, 5 )
		...
		self.m_staticText6 = wx.StaticText( self, wx.ID_ANY, u"配置快捷键：", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText6.Wrap( -1 )
		self.m_staticText6.SetFont( wx.Font( 11, 70, 90, 90, False, "宋体" ) )
		...
		self.m_staticText14 = wx.StaticText( self, wx.ID_ANY, u"开始播放", wx.Point( -1,-1 ), wx.Size( 100,-1 ), wx.ALIGN_RIGHT )
		...
		self.m_staticText11 = wx.StaticText( self, wx.ID_ANY, u"继续播放", wx.DefaultPosition, wx.Size( 100,24 ), wx.ALIGN_RIGHT )
		...
		self.m_staticText21 = wx.StaticText( self, wx.ID_ANY, u"循环播放", wx.Point( -1,-1 ), wx.Size( -1,-1 ), wx.ALIGN_RIGHT )
		...
		self.m_staticText31 = wx.StaticText( self, wx.ID_ANY, u"停止播放", wx.Point( -1,-1 ), wx.Size( 100,24 ), wx.ALIGN_RIGHT )
		...
		self.m_staticText41 = wx.StaticText( self, wx.ID_ANY, u"暂停播放", wx.Point( -1,-1 ), wx.Size( -1,-1 ), wx.ALIGN_RIGHT )
