...
FN_TITLE = [ u"开始播放", u"循环播放", u"暂停播放", u"继续播放", u"停止播放", u"F6", u"F7", u"F8", u"F9", u"F10", u"F11", u"F12",]

class RCConfigUI ( wx.Frame ):
    ...
    def cancelEvent( self, event ):
        ...
        self.Hide()
        RCConfigUI.desktop_state.set_state('active', 0)
